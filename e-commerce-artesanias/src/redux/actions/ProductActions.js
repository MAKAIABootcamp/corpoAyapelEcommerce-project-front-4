...
export const actionSearchProductAsync = (searchParam) => {
  return (dispatch, getState) => {
    try {
      const { productStore } = getState(); // Assuming the state structure has a property called 'productStore'
...
const actionSearchProductSync = (filteredProduct) => {
  return {
    type: productTypes.PRODUCTS_SEARCHED,
...
// export const actionSearchProductSync = (filteredProduct) => {
//   return {
//     type: productTypes.PRODUCTS_SEARCHED,
//     payload: filteredProduct,
//   };
